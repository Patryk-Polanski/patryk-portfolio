  ...
  return (
    <>
      ...
      >
        ...
        specialize in front end development, specifically React, Next.js,
        Node.js, CSS, Tailwind and I have experience working with content
        management systems such as WordPress, Sanity and Shopify.
      </div>
      <div
        aria-hidden='true'
        focusable='false'

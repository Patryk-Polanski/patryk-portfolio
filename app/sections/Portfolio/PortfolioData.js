export const portfolioData = [
  ...
  },
  {
    ...
    challenge: [
      ...
      'I started with building the promotional landing pages for the application and later moved onto working on the app itself. Even though most designs were complete, as this was an internal project without a client, I was still able to contribute to the overall app aesthetics with my own ideas. Among others, I was in charge of developing the sidebar, tabbable content, making reusable card components and creating form elements with client side validation. Tailwind and TypeScript helped create a cleaner, more manageable codebase both for styles and JavaScript/React logic. While the backend was still being implemented using Supabase and Vercel, I had a chance to experiment with the Cypress testing library and run tests for the front end of the app. Having multiple developers working on the project, it was completed moderately quickly and at the time of writing, it is accepting new users for early access. Screenshots of the app can be seen in the gallery below.',
    ],
    evaluation: [
      'To summarise, working on the Descripti web app was a good learning experience. Even though I’ve worked with the majority of the technologies in this tech stack in the past, but this time, I was able to observe how all of it comes together in a bigger real life project. I’ve realised the power of TypeScript in larger codebases and appreciated how Tailwind can streamline and speed up writing CSS. Unfortunately	I didn’t get much chance to study how the project was set up at the backend but I still managed to get a short introduction to Supabase and Vercel.',
    ],
    gallery: [
  ...
  },
  {
    ...
    evaluation: [
      "Overall, taking into account my programming experience at the time, I am pleased with my efforts and the finished application. Considering the complexity of the app and other synchronously running projects that had to be handed in, it was a fine attempt. Unfortunately my final year project assessors seemed to not have shared my enthusiasm and didn't appreciate my efforts. Despite this, I value this project as I have overcome many obstacles and have noticeably grown as a programmer. If I was to rebuild this project today, I would refine designs, add a database and implement a few major changes, most notably a different tech stack including Routing and of course React and TypeScript to make all the JavaScript logic more manageable.",
    ],
    gallery: [
